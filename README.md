...
This project uses Math.js (https://mathjs.org/) (v11.11.0) under the Apache License 2.0.  
See https://github.com/josdejong/mathjs/blob/develop/LICENSE for license details.  
Features:
Output graphs of complex functions in the form of a+bi on the complex plane  
Adjustable sliders  
Displays coordinates and arg() of the complex function  
